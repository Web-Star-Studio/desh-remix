 ...
 * @description Hook de e-mails de autenticação (signup, recovery, invite)
 * @status active
 * @calledBy Supabase Auth (webhook)
 * @note Custom CORS headers (x-lovable-signature, x-lovable-timestamp)
 */
...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'Confirme seu e-mail — DESH',
  invite: 'Você foi convidado para o DESH',
  magiclink: 'Seu link de acesso — DESH',
  recovery: 'Redefinir senha — DESH',
  email_change: 'Confirme a alteração de e-mail — DESH',
  reauthentication: 'Seu código de verificação — DESH',
}
...
// Configuration
const SITE_NAME = "DESH"
const SENDER_DOMAIN = "notify.desh.life"
const ROOT_DOMAIN = "desh.life"
const FROM_DOMAIN = "desh.life"
...
const SAMPLE_PROJECT_URL = "https://desh-ws.lovable.app"
